...
namespace Server
{
    ...
    public class MultiGame : Game
    {
        ...
        private List<ClientNotifier> gamers;
        ...
        public void AddGamer (ClientNotifier gamer)
        {
            gamers.Add(gamer);
        }
        ...
        /// </returns>
        public bool IsAGamer (ClientNotifier gamer)
        {
            for (int i = 0; i < gamers.Count; i++)
            {
        ...
        /// <param name="gamer">The gamer.</param>
        public void UpdateMove (string data, ClientNotifier gamer)
        {
            gamer.ToSend = false;
            gamer.Data = "";
